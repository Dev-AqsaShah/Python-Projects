...
class BookCollection:
    ...
    def create_new_book(self):
        ...
        is_book_read = input("Have you read this book? (yes/no): ").lower() == "yes"
    ...
    def find_book(self):
        ...
        if found_books:
            ...
            for book in found_books:
                print(f"{book['title']} by {book['author']} ({book['year']}) - {book['genre']} - Progress: {book['progress']}%")
        else:
    ...
    def show_all_books(self):
        ...
        for index, book in enumerate(self.book_list, 1):
            ...
            print(f"{index}. {book['title']} by {book['author']} ({book['year']}) - {book['genre']} - {reading_status} - Progress: {book['progress']}%")
    ...
    def update_book(self):
        ...
        for book in self.book_list:
            if book["title"].lower() == book_title.lower():
                ...
                book["progress"] = int(input(f"Enter reading progress (0-100) ({book['progress']}%): ") or book["progress"])
                self.save_to_file()
